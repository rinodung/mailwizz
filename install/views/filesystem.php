    ...
    <div class="box box-primary borderless">
        ...
        <div class="box-body">
            <div class="callout callout-info">
                Please see following <a href="https://www.mailwizz.com/kb/folders-writable-web-server/" target="_blank">KB article</a> to understand why we use 0777 for directory permissions.
            </div>
